...
public class Crawler implements Runnable{
	...
	private Object[] args;
	private HashSet<URL> myHitList;
	
		
  public Crawler(Object... myArgs){
	  this.args = myArgs;
  }
  
  public void run(){
	  try {
		this.crawl(this.args);
...
public HashSet<URL> getSet(){
	  return (HashSet<URL>) (this.myHitList).clone();
	  
  }
  
  public void crawl(Object... myArgs) throws MalformedURLException{
	  
	  String seed = (String) args[1];
	  String key = (String) args[2];
	  
	  if(args[0].equals(new Integer(0))){ // Flag is 0
		  String pathToTextFile = (String) args[3];
		  crawlExhaustion_Write(seed, key, pathToTextFile);
	  }
	  else{ // Flag must equal 1
		  crawlExhaustion_NoWrite(seed, key);
	  }
  ...
  public void crawlWithPageLimit(String seed_Url, String keyTo_Find, Integer pages_To_Crawl) throws MalformedURLException{
    ...
    while(!queueOf_SearchableURLs.isEmpty() && visitedSites.size() < limit){
     ...
     this.myHitList = sitesWith_Key; // return our URL path.

  }
  
  // Method for crawling with page limit (Unused)
  
  public void crawlExhaustion_Write(String seed_Url, String keyToFind, String pathToTxtFile) throws MalformedURLException{
  ...
  // Method for crawling to exhaustion and writing to file (flag == 0)
  
  
  
  public void crawlExhaustion_NoWrite(String seed_Url, String keyToFind) throws MalformedURLException{
  ...
  // Method for crawling to exhaustion without a write to file feature (Will print hit sites to terminal and flag == 1)
